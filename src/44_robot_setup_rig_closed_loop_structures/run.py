...
def main():
    ...
    parser.add_argument("--asset", default='/Isaac/Samples/Rigging/Gripper/Robotiq 2F-85/Robotiq_2F_85_edit.usd', help="Official asset-root-relative path, absolute local USD, or URL")
