...
```bash
"$ISAAC_SIM_PATH/python.sh" run.py --headless --steps 600 --output /tmp/isaac-tutorial-new-output
```
...
```json
{
  ...
  "action_count": 349,
  "max_joint_error_rad": 7.245266719024812e-06,
  "ground_z_m": -2.0
}
```
...
```json
{
  "run.py": "41da74ad8a5804d77b54d2fc5a4acad0616b69bf4270431ca1e7253c46c7c97f"
}
```
