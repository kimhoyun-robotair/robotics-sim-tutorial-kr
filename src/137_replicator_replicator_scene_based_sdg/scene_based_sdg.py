...
config["close_app_after_run"] = not config["keep_open"]
...
try:
    ...
    if assets_root_path is None:
        ...
        raise RuntimeError("Required Isaac Sim asset or writer could not be loaded")
    ...
    keep_gui_open(
        simulation_app, headless=config["launch_config"].get("headless", False), steps=args.steps
    )
finally:
