...
def main():
    ...
    parser.add_argument("--asset", default='/Isaac/Samples/Rigging/MockRobot/mock_robot_rigged.usd', help="Official asset-root-relative path, absolute local USD, or URL")
