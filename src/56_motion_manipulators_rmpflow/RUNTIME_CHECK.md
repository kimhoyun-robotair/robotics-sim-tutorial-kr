...
```bash
"$ISAAC_SIM_PATH/python.sh" run.py --headless --steps 180 --output /tmp/isaac-tutorial-new-output
```
...
```json
{
  "last_position_error_m": 0.002240093072170879
}
```
...
```json
{
  "run.py": "c50cc34a64b3c8779937b9a27cb1536b9fbab97c65b644bd8d04f5b647a29c87"
}
```
