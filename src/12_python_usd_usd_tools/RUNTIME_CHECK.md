...
```json
{
  "broken_has_body": false,
  "repaired_has_body": true,
  "path_changes": [
    [
      "old_assets/body.usda",
      "moved_assets/body.usda"
    ]
  ],
  "variants": [
    "blue",
...
- process_exit: 통과
- repair_and_variant: 통과

## 실행 입력 파일 SHA-256

```json
{
  "run.py": "3a269ea7c965d591bb52e834c01dbc52add2b8d55bd65ac1a5ade2bdfd36ba11"
}
```
