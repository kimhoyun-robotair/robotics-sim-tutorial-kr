...
```bash
"$ISAAC_SIM_PATH/python.sh" run.py --headless --steps 120
```
...
{
  "samples": 120,
  "rest_height_m": 0.24999813735485077
}
```
...
```json
{
  "run.py": "30e6ea185ffb6ca1126eb8ca2d5583634286ad4d4c4069afdcbb3e9d2a127666"
}
```
