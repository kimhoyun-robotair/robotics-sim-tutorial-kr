...
```bash
"$ISAAC_SIM_PATH/python.sh" run.py --example basic --headless --frames 2 --output /tmp/isaac-tutorial-new-output
```
...
```json
{
  "run.py": "1fa81bb58908c04d83055cb8f635054ec959e53d273695627fd38da260a0fe39"
}
```
