...
이 패키지의 기본 `lesson.json`은 제공한 `custom_room.usda`를 참조합니다. 위 창고 준비 단계 대신 다음 단계를 진행합니다. 바닥과 주황색 상자, Dome Light는 패키지 자체에 있어 환경 다운로드가 필요 없습니다. IRA 사람 자산은 별도로 필요합니다.
