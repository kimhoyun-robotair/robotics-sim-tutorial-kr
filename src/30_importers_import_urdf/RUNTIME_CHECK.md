...
```bash
"$ISAAC_SIM_PATH/python.sh" run.py --headless --steps 120 --output /tmp/isaac-tutorial-new-output
```
...
```json
{
  "source": "/home/hoyunkim/robotics-sim-tutorial-kr/src/importers_import_urdf/arm.urdf",
  "prim_path": "/tutorial_arm",
  "joint_names": [
    "shoulder"
  ],
  "joint_positions": [
...
```json
{
  "run.py": "543499b50e0f2896ae6e0482aa46bb8137da42c321f1a9e06816177b20a4a2bc",
  "arm.urdf": "3b400ca5d2a0eb5778e422a9826dd287d69199d62428b42721565b0f4efe8333"
}
```
