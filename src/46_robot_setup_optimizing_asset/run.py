...
def main():
    ...
    parser.add_argument("--asset", default='/Isaac/Samples/Rigging/Jetbot/Jetbot_Base/Jetbot_base.usd', help="Official asset-root-relative path, absolute local USD, or URL")
