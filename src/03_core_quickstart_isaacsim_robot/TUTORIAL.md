...
관절로 연결된 강체 시스템을 **articulation**이라고 부릅니다. DOF는 로봇에서 제어 가능한 자유도이며, 전체 관절 수에는 고정 관절(Fixed Joint) 등이 포함될 수 있어 두 개수가 항상 같지는 않습니다.
...
여기서 단계는 step이고 자산은 asset으로 봐주시면 됩니다.
