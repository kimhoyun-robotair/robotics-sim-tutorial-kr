...
```bash
"$ISAAC_SIM_PATH/python.sh" run.py --headless --steps 30 --output /tmp/isaac-tutorial-new-output
```
...
```json
{
  "run.py": "09bc2b1bc082cf3195a0d0af236d4f9d39fb1b73db9a2d23d3dfdf8f125a296e"
}
```
