...
> 이 문서는 **2026년 9월 7일 구성의 검증 기록**이다. 9월 8일 수정에서 F1TENTH은 기존 Building Editor 맵과 기본 센서 구성으로 돌아갔고, 센서 실습 차량은 4륜 Ackermann으로 바뀌었다. 아래의 이전 센서 차량 화면과 F1 거리값은 당시 구성에 해당한다. 현재 구성의 검증 결과는 [9월 8일 변경 기록](12_f1_sensor_revision.md), 센서 실습은 [5장](05_sensors.md)을 따른다.
